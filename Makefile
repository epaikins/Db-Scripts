...
.PHONY: help config backup restore full backup-xtra restore-xtra clean check
...
help:
	...
	@echo "  make restore         - Restore (BACKUP_PATH=./backups/db_* or s3://bucket/prefix/db_*)"
...
restore: check
	@test -n "$(BACKUP_PATH)" || (echo "Usage: make restore BACKUP_PATH=./backups/yourdb_20250223_120000 or BACKUP_PATH=s3://bucket/prefix/yourdb_20250223_120000" && exit 1)
